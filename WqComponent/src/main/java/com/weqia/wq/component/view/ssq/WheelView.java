...
public class WheelView extends View {
     ...
     * 默认字体
     */
    private float normalFont = 12.0f;
    /**
     * 选中的时候字体
     */
    private float selectedFont = 14.0f;
    /**
     * 单元格高度
     */
     ...
     * 默认字体颜色
     */
    private int normalColor = 0xe1e1e1;
    /**
     * 选中时候的字体颜色
     */
    private int selectedColor = 0xe1e1e1;
    /**
     * 蒙板高度
     */
    ...
    private void noEmpty() {
        if (!noEmpty)
            return;
        if (StrUtil.listIsNull(itemList)) {
            return;
        }
    ...
    private void drawLine(Canvas canvas) {
        ...
        if (linePaint == null) {
            ...
            linePaint.setColor(getResources().getColor(R.color.line_grey));
            linePaint.setStrokeWidth(lineWidth);
        }

        canvas.drawLine(0, controlHeight / 2 - unitHeight / 2 + 2,
                controlWidth + 2, controlHeight / 2 - unitHeight / 2 + 2, linePaint);
        canvas.drawLine(0, controlHeight / 2 + unitHeight / 2 - 2,
                controlWidth + 2, controlHeight / 2 + unitHeight / 2 - 2, linePaint);
    }
    ...
    private void drawMask(Canvas canvas) {
        LinearGradient lg = new LinearGradient(0, 0, 0, maskHight, 0xe1e1e1,
                0xe1e1e1, TileMode.MIRROR);
...
//                0x00f2f2f2, TileMode.MIRROR);
        ...
        LinearGradient lg2 = new LinearGradient(0, controlHeight - maskHight,
                0, controlHeight, 0xe1e1e1, 0xe1e1e1, TileMode.MIRROR);
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        normalFont = attribute.getDimension(
                R.styleable.WheelView_normalTextSize, 10.0f);
        selectedFont = attribute.getDimension(
                R.styleable.WheelView_selectedTextSize, 10.0f);
        itemNumber = attribute.getInt(R.styleable.WheelView_itemNumber, 7);
        normalColor = attribute.getColor(
                R.styleable.WheelView_normalTextColor, 0xe1e1e1);
        selectedColor = attribute.getColor(
                R.styleable.WheelView_selectedTextColor, 0xe1e1e1);
