...
public class GifView extends View {
    ...
    public String getmMovieFilePath() {
        return mMovieFilePath;
    }

    public void setmMovieFilePath(String mMovieFilePath) {
        this.mMovieFilePath = mMovieFilePath;
        movie = Movie.decodeFile(mMovieFilePath);
        requestLayout();
    }
