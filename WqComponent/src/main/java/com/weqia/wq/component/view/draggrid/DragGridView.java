...
public class DragGridView extends GridView {
    ...
    private boolean isParentIntercept = false;
...
//            selectView.findViewById(R.id.delete_img).setVisibility(VISIBLE);
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        if (isParentIntercept) {             //防止本view和父viewGroup或者activity滑动冲突
            return false;
        } else {
    ...
    public boolean isParentIntercept() {
        return isParentIntercept;
    }

    public void setParentIntercept(boolean parentIntercept) {
        isParentIntercept = parentIntercept;
    }
}
