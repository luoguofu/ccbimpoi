...
public class ClipZoomImageView extends ImageView
    ...
    public Bitmap clip() {
        ...
        draw(canvas);
        return Bitmap.createBitmap(bitmap, mHorizontalPadding, getHVerticalPadding(), getWidth()
                - 2 * mHorizontalPadding, getWidth() - 2 * mHorizontalPadding);
    }
