...
import com.weqia.utils.http.okgo.cookie.CookieJarImpl;
...
public class OkGo {
     ...
     */
    public OkGo debug(boolean isPrintException) {
    ...
    public OkGo setCertificates(InputStream... certificates) {
        SSLUtils.SSLParams sslParams = SSLUtils.getSslSocketFactory(null, null, certificates);
        okHttpClientBuilder.sslSocketFactory(sslParams.sSLSocketFactory, sslParams.trustManager);
        return this;
    }
    ...
    /** 添加全局公共请求参数 */
    public OkGo addCommonParams(RequestParams commonParams) {
